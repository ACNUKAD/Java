//onde vou declarar minhas variáveis
...
public class Prova {
	...
	lista [1] = new Questao("Quanto é 2+1? ","3");
	lista [2] = new Questao("A Carol é empenhada? ", "Sim");
	lista [3] = new Questao("Quantos anos a Carol tem? ", "25");
	lista [4] = new Questao("A Carol é inteligente? ","oh yeah");
